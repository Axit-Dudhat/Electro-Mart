...
const Footer = () => {
  return (
      ...
      <div className="footer-content">
        <div className="footer-section">
          <div className="footer-brand">
            <h3 className="brand-name">Electro Mart</h3>
          ...
          <div className="email-input-container">
            ...
            <button className="send-button">
              <img 
                src="https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-24/1NLQ4xFdrS.svg" 
                alt="Send" 
              />
            </button>
          </div>
    ...
    <div className="footer-section">
      <h4 className="section-title">Quick Link</h4>
      <div className="footer-links">
  ...
  <div className="footer-bottom">
    <div className="copyright">
      <img 
        src="https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-24/zfjxLVy1H5.svg" 
        alt="Copyright" 
